...
import { z } from "zod"
import { splitTrafficBlockDefaultValue, splitTrafficBlockSchema } from "../../blocks/split-traffic/schema"
...
export const splitTrafficNodeDefaultValue = (name = "Split Traffic"): SplitTrafficNodeSchema => ({
  id: createId(),
  name,
