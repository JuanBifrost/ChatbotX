...
import { ClockIcon, CompassIcon, ExternalLinkIcon, FilterIcon, InfoIcon, MailIcon, MessageCircleMoreIcon, Plus, ShuffleIcon, ZapIcon } from "lucide-react"
import { useState } from "react"
import { PanelAction } from "../types"

export function AddBlockButton({ onChooseAction }: { onChooseAction: (name: PanelAction) => void }) {
